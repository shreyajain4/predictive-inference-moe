...
def main() -> None:
    ...
    # GGUFReader gives tensor.data_offset which is RELATIVE to start of tensor data section.
    # The absolute file offset = r.data_offset + tensor.data_offset.
    # (r.data_offset is the file offset where tensor data begins, after metadata.)
    tensor_data_start = int(r.data_offset)
    ...
    for t in r.tensors:
        ...
        abs_base = tensor_data_start + int(t.data_offset)
